...
<head>
  ...
  <title>PLTS Under Construction</title>
...
<body>
  ...
  <header id="header">
    <div class="container-fluid d-flex justify-content-between align-items-center">
      ...
      <div class="logo">
        ...
        <a href="{{ route('/') }}"><img src="{{ asset('logo-pju.png') }}" alt="" class="img-fluid"></a>
      </div>
  ...
  <section id="hero">
    <div class="hero-container">
      <h1>PLTS Petrogas</h1>
      <h2>Maaf Website Sedang Dalam Pengembangan Untuk Info Lebiih Lanjut Terkait <br> Menu Harap Hubungi Admin</h2>
      <div class="countdown" data-count="2023/05/30" data-template="%d days %h:%m:%s"></div>
